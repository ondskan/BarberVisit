...
<html>
<head>
    <title>.: BarberVisitApp :. - My visit list</title>
...
--%>
                ...
                <tbody>
                <c:forEach items="${myVisitsList}" var="s">
                    <tr>
                        <td><c:out value="${s.name}"/></td>
                        <td><c:out value="${s.duration}"/></td>
                        <td><c:out value="${s.price}"/></td>
                        <td><c:out value="${s.term}"/></td>

                            <%--                <td><c:out value="${s.confirmation}"/></td>--%>
                            <%--                        <td><c:out value="${s.barberservice}"/></td>
                                                    <td><c:out value="${s.client}"/></td>--%>
